...
Go to `https://realtortasksai.com/connect` and enter the connection code shown by the installer.

## The account is not found

Use the same email address used for RealtorTasksAI signup or purchase. Manual license-key entry is available only as a fallback.
